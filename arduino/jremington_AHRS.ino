...
float G_offset[3] = {366.8, 61.5, -7.9};
...
float A_Ainv[3][3]
{ {  1.06701,  0.04324, 0.03784},
  {  0.04324,  0.99886, -0.00433},
  {  0.03784, -0.00433,  0.93587}
};
...
float M_Ainv[3][3]
{ {  2.22325,  0.01026,  0.06941},
  {  0.01026,  2.16890,  -0.02618},
  {  0.06941,  -0.02618,  2.01747}
};
